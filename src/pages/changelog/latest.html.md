...
*   [Tabstop syntax](../tabstops.html) has changed in
...
*   Linux users may need to install the <acronym title="Smart Common
  ...
  See "[Linux Software
  Prerequisites](../install.html#System_Req_Lin)" in the Installation Guide for details. (Bug
  70812)
...
*   Python: Breakpoints will not work with the [Psyco](http://psyco.sourceforge.net/) extension enabled.
  The Komodo [FAQ](../trouble.html#psyco_debug) has a
