...
CSS files are not being generated by DocPad, instead you'll want to manually
invoke sass to watch CSS for changes:

`sass --watch src/documents/styles/style.css.scss:out/styles/style.css`
